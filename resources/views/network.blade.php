...
<div   class="mt-3 mr-5" style=" text-align:end;" >
  <a href="/"><button  class="border border-dark bg-dark text-light" >login</button></a>
  <a href="registration"><button  class="border border-dark bg-dark text-light">Registration</button></a>
</div>

<img src="{{asset('images/gyan vihar banner 2.jpg')}}" width="100%" class="mt-3">
<!--footer start-->
