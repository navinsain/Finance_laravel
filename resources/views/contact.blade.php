...
<div class="col-lg-7 border border-dark mt-5 container" style="background-color:white">
    
      <div class="row pt-5 p-5">
        <div class="col-6 ">
          <p style="font-size: 15px"><b>Contact Details</b></p>
          <i class="fa fa-user mt-3 fa-2x" aria-hidden="true"></i>
          <address style="font-size:12px;color: #000;">
                   <b>Mr. sushil kumar jain</b> <br> 
                   Phone: +91 9799562538<br>
                    Jaipur, Rajasthan<br>
                   
          </address>
        </div>
        <div class="col-6">
          <p style="font-size:15px"><b>Contact Us</b></p>
          <form action="contact_submit" method="post">
            @csrf
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label"></label>
                <textarea class="form-control" name="requirements" id="exampleFormControlTextarea1" rows="3" style="font-size: 12px;" placeholder="Enter Your Requirements" ></textarea>
            </div>
          
                  <div class="input-group margin-bottom-sm">
                    <div class="d-flex  bd-highlight" style="font-size:12px">
                      <!-- country codes (ISO 3166) and Dial codes. -->
<select name="countryCode" id="" style="width:90%">
  <option data-countryCode="GB" value="91" Selected>India (+91)</option>
  <option data-countryCode="US" value="1">USA (+1)</option>
  <optgroup label="Other countries">
    <option data-countryCode="🇦🇩" value="🇦🇩">🇦🇩 (+213)</option>
    ...
    <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                   ...
                   <input class="form-control" name="number" type="number" placeholder="Number" style=" font-size: 12px; ">
                     </div><br>
                     <div class="input-group">

                  <span class="input-group-addon"><i class="fa fa-user fa-fw fa-2x" style=" " aria-hidden="true"></i></span>
                 <input class="form-control" name="name" type="text" placeholder="Name" style="font-size: 12px;">
                     </div><br>
                     <div class="input-group">

                  <span class="input-group-addon"><i class="fa fa-user fa-fw fa-2x" style=" " aria-hidden="true"></i></span>
                 <input class="form-control" name="email" type="email" placeholder="Email" style="font-size: 12px;">
                     </div>
                     <div style="text-align: center;">
                     <button class="mt-4  text-light btn btn-sm"style="background-color:black;"><b>Contact Now</b></button>
                   </div>
                    </form>
                  </div>
                </div>
